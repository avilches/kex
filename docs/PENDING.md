...
- [BUG-52](pending/bugs/BUG-52-notes-hygiene-varios.md) - Varios items de correccion y limpieza de bajo impacto en el stack de notas (lectura corta en `read_head`, fecha incorrecta en orden "Created", `quickAccess` colgado en `kex.json`, last-writer-wins entre ventanas)
