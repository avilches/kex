...
- Outcome: work plan creado en docs/upstream-2026-06-21.md; bug fixes (Bucket B) ejecutados en rama sync/upstream-2026-06-21. Bucket C (features) y bumps de dependabot pendientes de decision del usuario.
