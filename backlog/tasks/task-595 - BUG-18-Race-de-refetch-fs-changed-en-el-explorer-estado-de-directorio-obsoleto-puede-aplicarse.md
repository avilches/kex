...
id: TASK-595
title: >-
  BUG-18: Race de refetch fs:changed en el explorer: estado de directorio
  obsoleto puede aplicarse
status: To Do
assignee: []
...
dependencies: []
references:
  - docs/pending/bugs/BUG-18-race-refetch-fs-changed-explorer.md
priority: medium
type: bug
ordinal: 588000
---
