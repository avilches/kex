...
id: TASK-622
title: >-
  BUG-54: El descarte de cambios confirma contra el repo activo, no contra el
  que se pidio (perdida irrecuperable)
status: To Do
assignee: []
...
dependencies: []
references:
  - docs/pending/bugs/BUG-54-discard-confirma-contra-el-repo-equivocado.md
priority: high
type: bug
ordinal: 615000
---
