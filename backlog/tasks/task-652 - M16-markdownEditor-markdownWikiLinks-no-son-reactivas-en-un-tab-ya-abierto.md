---
id: TASK-652
title: 'M16: markdownEditor/markdownWikiLinks no son reactivas en un tab ya abierto'
status: To Do
assignee: []
...
dependencies: []
references:
  - docs/pending/improvements/M16-markdown-prefs-no-reactivas-en-tab-abierto.md
priority: low
type: task
ordinal: 645000
---
