...
export const WORKSPACE_ICON_PALETTE = [
  ...
  { name: "AiBeautifyIcon", label: "AI Beautify", icon: AiBeautifyIcon },
  { name: "ArtificialIntelligence02Icon", label: "Artificial Intelligence", icon: ArtificialIntelligence02Icon },
  { name: "MachineRobotIcon", label: "Robot", icon: MachineRobotIcon },
  { name: "AnonymousIcon", label: "Anonymous", icon: AnonymousIcon },
  { name: "RadioactiveAlertIcon", label: "Radioactive", icon: RadioactiveAlertIcon },
