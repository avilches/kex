...
const REPO_URL = "https://github.com/avilches/kex";
const WEBSITE = "https://github.com/avilches/kex";
...
export function AboutSection() {
  ...
  const [name, setName] = useState("Kex");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd className="font-mono text-[11.5px]">app.betauer.kex</dd>
